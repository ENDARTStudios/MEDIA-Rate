...
function main() {
  ...
  "boulevard":{en:"A quiet drama unfolding over the course of a single day on a tree-lined boulevard, where a man confronts the choices that shaped his life and discovers unexpected redemption.",es:"Un drama tranquilo que se desarrolla a lo largo de un solo día en un bulevar arbolado, donde un hombre enfrenta las elecciones que moldearon su vida y descubre una redención inesperada."},
  "as-ovelhas-detetives":{en:"When a flock of sheep on a peaceful farm starts disappearing, an unlikely team of woolly detectives must solve the mystery before there's no one left to bah.",es:"Cuando un rebaño de ovejas en una granja pacífica comienza a desaparecer, un equipo improbable de detectives lanudos debe resolver el misterio antes de que no quede nadie para balar."},
  "mori-no-kuma-san-toumin-chuu":{en:"A gentle slice-of-life anime following a bear preparing for hibernation in a magical forest, making friends with the woodland creatures along the way.",es:"Un anime tranquilo que sigue a un oso preparándose para la hibernación en un bosque mágico, haciendo amigos con las criaturas del bosque en el camino."},
  "rote-rosen":{en:"A German romantic drama set in a small town where a florist's red roses carry messages of love, loss, and secrets between the residents.",es:"Un drama romántico alemán ambientado en un pequeño pueblo donde las rosas rojas de una florista llevan mensajes de amor, pérdida y secretos entre los residentes."},
  "lei-ordem-unidade-de-v-timas-especiais":{en:"An elite squad of NYPD detectives investigates sexually based offenses in this hard-hitting and emotional series that has defined the crime drama genre for over two decades.",es:"Un escuadrón de élite de detectives del NYPD investiga delitos sexuales en esta serie contundente y emotiva que ha definido el género de drama criminal durante más de dos décadas."},
  "o-guia-do-mochileiro":{en:"Arthur Dent is whisked off Earth moments before its destruction and embarks on a hilarious journey through space with an alien researcher, discovering the answer to life, the universe, and everything.",es:"Arthur Dent es llevado de la Tierra momentos antes de su destrucción y emprende un viaje hilarante por el espacio con un investigador alienígena, descubriendo la respuesta a la vida, el universo y todo lo demás."},
  ...
  "re-zero":{en:"A young man is transported to a fantasy world and discovers he has the ability to return to a save point upon death, forcing him to relive traumatic events to protect those he loves.",es:"Un joven es transportado a un mundo de fantasía y descubre que tiene la capacidad de volver a un punto de guardado al morir, obligándolo a revivir eventos traumáticos para proteger a quienes ama."},
  "pokemon":{en:"A young trainer journeys across regions to catch, train, and battle creatures called Pokemon, aiming to become the greatest Pokemon Master in the world.",es:"Un joven entrenador viaja por regiones para capturar, entrenar y luchar con criaturas llamadas Pokemon, con el objetivo de convertirse en el mejor Maestro Pokemon del mundo."},
  "doraemon":{en:"A robotic cat from the 22nd century travels back in time to help a young boy navigate the challenges of childhood using futuristic gadgets from his magical pocket.",es:"Un gato robótico del siglo XXII viaja al pasado para ayudar a un niño a navegar los desafíos de la infancia usando gadgets futuristas de su bolsillo mágico."},
  "god-of-war-ragnarok":{en:"Kratos and his son Atreus journey through the Nine Realms as Ragnarok approaches, facing Norse gods and monsters in an epic conclusion to the Norse saga.",es:"Kratos y su hijo Atreus viajan por los Nueve Reinos mientras se acerca el Ragnarok, enfrentando dioses y monstruos nórdicos en una conclusión épica de la saga nórdica."},
  "red-dead-redemption-2":{en:"Arthur Morgan and the Van der Linde gang are on the run from the law in America's fading Wild West, grappling with loyalty, survival, and the end of an era.",es:"Arthur Morgan y la banda Van der Linde huyen de la ley en el ocaso del Salvaje Oeste americano, lidiando con la lealtad, la supervivencia y el fin de una era."},
  "the-witcher-3":{en:"Geralt of Rivia, a monster hunter for hire, searches for his adopted daughter while navigating a war-torn world and confronting an otherworldly threat.",es:"Geralt de Rivia, un cazador de monstruos a sueldo, busca a su hija adoptiva mientras navega por un mundo devastado por la guerra y enfrenta una amenaza sobrenatural."},
  "duna":{en:"Paul Atreides travels to the desert planet Arrakis, where his family controls the universe's most valuable substance, and a destiny greater than he can imagine awaits.",es:"Paul Atreides viaja al planeta desértico Arrakis, donde su familia controla la sustancia más valiosa del universo, y le espera un destino más grande de lo que puede imaginar."},
  "cem-anos-de-solidao":{en:"The multi-generational saga of the Buendia family in the mythical town of Macondo, weaving magical realism with the history of Latin America.",es:"La saga multigeneracional de la familia Buendía en el mítico pueblo de Macondo, entrelazando realismo mágico con la historia de América Latina."},
  "o-hobbit":{en:"Bilbo Baggins is swept into an epic quest to reclaim the lost Dwarf kingdom of Erebor from the fearsome dragon Smaug, discovering courage he never knew he had.",es:"Bilbo Bolsón se ve arrastrado a una búsqueda épica para recuperar el reino enano perdido de Erebor del temible dragón Smaug, descubriendo un coraje que nunca supo que tenía."},
  "watchmen":{en:"In an alternate 1985 where superheroes exist, a murder investigation unravels a conspiracy that forces retired heroes to confront their past and the nature of power.",es:"En un 1985 alternativo donde existen los superhéroes, una investigación de asesinato revela una conspiración que obliga a héroes retirados a confrontar su pasado y la naturaleza del poder."},
  "the-boys":{en:"A group of vigilantes sets out to take down corrupt superheroes who abuse their powers, exposing the dark side of fame and corporate-controlled heroism.",es:"Un grupo de justicieros se propone derribar a superhéroes corruptos que abusan de sus poderes, exponiendo el lado oscuro de la fama y el heroísmo controlado por corporaciones."},
  "invincible":{en:"A teenager inherits his father's superhuman powers and discovers that being a hero comes with brutal consequences and devastating family secrets.",es:"Un adolescente hereda los poderes sobrehumanos de su padre y descubre que ser un héroe conlleva consecuencias brutales y secretos familiares devastadores."},
  "avatar-aang-o-ltimo-mestre-do-ar":{en:"Aang, the last Airbender and the Avatar, must master all four elements to end the Fire Nation's war and restore balance to the world.",es:"Aang, el último Maestro del Aire y el Avatar, debe dominar los cuatro elementos para detener la guerra de la Nación del Fuego y restaurar el equilibrio del mundo."},
  "silo":{en:"In a dystopian future, the last ten thousand people on Earth live in a giant underground silo, where a sheriff investigates a murder and uncovers the truth about their confined world.",es:"En un futuro distópico, los últimos diez mil habitantes de la Tierra viven en un silo subterráneo gigante, donde un sheriff investiga un asesinato y descubre la verdad sobre su mundo confinado."},
  "origem":{en:"A scientist makes a discovery that challenges the boundaries between science and faith, forcing humanity to reconsider its deepest beliefs about where we come from.",es:"Un científico hace un descubrimiento que desafía los límites entre ciencia y fe, obligando a la humanidad a reconsiderar sus creencias más profundas sobre nuestro origen."},
  "backrooms-um-n-o-lugar":{en:"A group of explorers discovers an endless maze of empty yellow rooms existing beyond reality, where the laws of physics no longer apply and something lurks in the silence.",es:"Un grupo de exploradores descubre un laberinto interminable de habitaciones amarillas vacías que existen más allá de la realidad, donde las leyes de la física ya no se aplican y algo acecha en el silencio."},
...
const TRANSLATIONS_BY_ID: Record<string,{en:string;es:string}> = {
  ...
  "avatar-aang-o-ltimo-mestre-do-ar":{en:"Avatar Aang: The Last Airbender",es:"Avatar Aang: El Ultimo Maestro del Aire"},
