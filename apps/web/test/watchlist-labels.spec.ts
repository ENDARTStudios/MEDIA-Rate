...
const LOCALES: Record<string, Locale> = { "pt-BR": ptBR as unknown as Locale, "en-US": enUS as unknown as Locale, "es-ES": esES as unknown as Locale };
...
const CASOS: Array<{
  ...
  // Filmes/séries → ver
  { tipo: "movie", coluna: "WANT", esperado: "queroVer", pt: "Quero Ver", en: "Want to Watch", es: "Quiero Ver" },
  { tipo: "series", coluna: "WATCHING", esperado: "vendo", pt: "Vendo", en: "Watching", es: "Viendo" },
  { tipo: "FILME", coluna: "COMPLETED", esperado: "vi", pt: "Vi", en: "Watched", es: "Vi" },
  // Games → jogar
  { tipo: "game", coluna: "WANT", esperado: "queroJogar", pt: "Quero Jogar", en: "Want to Play", es: "Quiero Jugar" },
  { tipo: "GAME", coluna: "WATCHING", esperado: "jogando", pt: "Jogando", en: "Playing", es: "Jugando" },
  { tipo: "game", coluna: "COMPLETED", esperado: "zerei", pt: "Zerei", en: "Beat", es: "Completé" },
  // Livros/HQs/mangás → ler
  { tipo: "book", coluna: "WANT", esperado: "queroLer", pt: "Quero Ler", en: "Want to Read", es: "Quiero Leer" },
  { tipo: "comic", coluna: "WATCHING", esperado: "lendo", pt: "Lendo", en: "Reading", es: "Leyendo" },
  { tipo: "MANGA", coluna: "COMPLETED", esperado: "li", pt: "Li", en: "Read", es: "Leí" },
  // DROPPED → comum
  { tipo: "game", coluna: "DROPPED", esperado: "abandonei", pt: "Abandonei", en: "Dropped", es: "Abandoné" },
  { tipo: "movie", coluna: "DROPPED", esperado: "abandonei", pt: "Abandonei", en: "Dropped", es: "Abandoné" },
  { tipo: "manga", coluna: "DROPPED", esperado: "abandonei", pt: "Abandonei", en: "Dropped", es: "Abandoné" },
];

describe("colunaLabelKey (T239) — matriz tipo×coluna×locale", () => {
  it.each(CASOS)(
    "$tipo/$coluna → $esperado ($pt)",
    ({ tipo, coluna, esperado, pt, en, es }) => {
