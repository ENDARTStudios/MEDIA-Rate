...
const MANUAL: any[] = [
  ...
  anime("a2", "frieren", "Frieren e a Jornada para o Além", 2023, ["Fantasia", "Aventura", "Drama"], "Após derrotar o Rei Demônio, a elfa Frieren embarca em uma jornada para entender o significado da vida e das conexões humanas.", 8.8, "/dqBW9v7NAMtH1RH1E7xuhNKCY0A.jpg", "/2ECx2GvAz5Qx0SENYnDrYBVsaAR.jpg"),
  anime("a3", "hunter-x-hunter", "Hunter x Hunter", 2011, ["Ação", "Aventura", "Fantasia"], "Gon Freecss descobre que seu pai é um Hunter lendário e decide seguir seus passos, enfrentando desafios e fazendo aliados.", 8.7, "/9Y5WQvqUHYsNYDw4JUz9J3Gx5RW.jpg", "/m3xI0Qri29GjhE2oHaNV3G39cNA.jpg"),
  anime("a4", "bleach", "Bleach", 2004, ["Ação", "Sobrenatural", "Fantasia"], "Ichigo Kurosaki ganha poderes de Shinigami e deve proteger os vivos de espíritos malignos enquanto navega pela Soul Society.", 8.4, "/2EewmxXe72ogD0VMhPO1E3Y8kQx.jpg", "/dYWdZHCr3ZDEgx4MHjlST1NslR8.jpg"),
  ...
  anime("a10", "one-piece", "One Piece", 1999, ["Ação", "Aventura", "Fantasia", "Comédia"], "Monkey D. Luffy reúne uma tripulação pirata em busca do tesouro One Piece para se tornar o Rei dos Piratas.", 8.7, "/cMD9Ygz1Y3bQHr2J0kMkXH3LGOt.jpg", "/6GCOlQyjyyRjvYJxQ0GQ0Rg4jBR.jpg"),
