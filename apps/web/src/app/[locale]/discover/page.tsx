...
export default async function DiscoverPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <p className="text-[#9CA3AF] mb-6">Mídias em destaque com maiores MEDIA Scores. <a href="/catalog" className="text-[#818CF8] hover:text-[#A5B4FC] underline">{t("title")} completo</a></p>
