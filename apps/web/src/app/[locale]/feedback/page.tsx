      ...
      {sent ? (
        ...
        <>
          ...
          <div className="flex justify-center gap-2 mb-6 text-2xl">
            {[1,2,3,4,5].map(n => (
              <button key={n} onClick={() => setSent(true)} className="hover:scale-125 transition-transform">
                {n <= 4 ? "⭐" : "🌟"}
              </button>
            ))}
          </div>
          <p className="text-xs text-[#6B7280]">
            Ou fale diretamente: <a href="https://discord.gg/mediarate" className="text-[#818CF8]">Discord</a> · <a href="mailto:feedback@mediarate.app" className="text-[#818CF8]">Email</a>
          </p>
        </>
      )}
    </div>
