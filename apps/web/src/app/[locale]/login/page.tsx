    ...
    <div className="min-h-[calc(100vh-4rem)] flex">
      <div className="hidden md:flex flex-1 items-center justify-center bg-gradient-to-br from-[#11111E] via-[#1C1C2E] to-[#09090F] p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md text-center">
          ...
          <h1 className="text-3xl font-heading font-bold text-[#EDE7DC] mb-4">{t("loginSubtitle")}</h1>
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-8 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-[#9CA3AF] mb-6">
            {t("noAccount")}{" "}
            <Link href="/register" className="text-[#818CF8] hover:text-[#A5B4FC]">{t("signUp")}</Link>
          </p>
