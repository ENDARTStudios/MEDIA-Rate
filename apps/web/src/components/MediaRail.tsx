...
const MOCK_ITEMS: Record<string, MediaItem[]> = {
  FILME: [
    ...
    { id: "mf8", titulo: "Frieren", tipo: "FILME", ano_lancamento: 2023, imagem_url: null, score: 88 },
  ],
  SERIE: [
    ...
    { id: "ms2", titulo: "Frieren e a Jornada", tipo: "SERIE", ano_lancamento: 2023, imagem_url: null, score: 88 },
    { id: "ms3", titulo: "Hunter x Hunter", tipo: "SERIE", ano_lancamento: 2011, imagem_url: null, score: 87 },
    { id: "ms4", titulo: "Bleach", tipo: "SERIE", ano_lancamento: 2004, imagem_url: null, score: 84 },
    { id: "ms5", titulo: "One Piece", tipo: "SERIE", ano_lancamento: 1999, imagem_url: null, score: 87 },
