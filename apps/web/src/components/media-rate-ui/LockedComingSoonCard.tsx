...
export function LockedComingSoonCard({ type, onNotify }: LockedComingSoonCardProps) {
    ...
    <>
      ...
      >
        <div className="aspect-[2/3] bg-[#1B1B2C] relative overflow-hidden">
          {/* Simula capa genérica com o accent da categoria */}
          <div
            className="absolute inset-0 opacity-25 blur-[4px]"
            style={{
              background: `linear-gradient(135deg, ${accent}66 0%, transparent 60%)`,
            }}
            aria-hidden="true"
          />
          <div
