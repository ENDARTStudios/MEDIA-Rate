  ...
  return (
    <svg viewBox="0 0 120 120" aria-hidden="true" data-part="icon" data-testid="icon-magazine">
      ...
      <g filter="url(#ic-hq-shadow)">
        <rect x="14" y="12" width="92" height="92" rx="8" fill="url(#ic-hq-page)" stroke="#7C3AED" strokeOpacity="0.5" strokeWidth="2" />
      </g>
      <rect x="20" y="18" width="36" height="28" rx="4" fill="url(#ic-hq-dark)" />
      <rect x="60" y="18" width="36" height="28" rx="4" fill="#FDF2F8" stroke="#7C3AED" strokeWidth="1.5" />
      <rect x="20" y="50" width="36" height="44" rx="4" fill="#FDF2F8" stroke="#7C3AED" strokeWidth="1.5" />
      ...
      <path d="M74 64 C74 57 88 57 88 64 C88 69 84 71 80 71.5 L82 76 L76 71 C72 70 74 64 74 64 Z" fill="#FFFFFF" stroke="#7C3AED" strokeWidth="2" />
      <text x="81" y="69" textAnchor="middle" fontFamily={FONT} fontSize="7" fontWeight="900" fill="#7C3AED">POW!</text>
    </svg>
  );
}
