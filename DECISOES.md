...
- Ordem do Operador: custo zero. S� ferramentas gratuitas/open-source. Datadog, NewRelic e Codecov tier pago s�o **descartados do escopo ativo** � reavaliar apenas com retorno financeiro comprovado (nova fase, n�o pend�ncia).
...
- Regra permanente: qualquer proposta futura de ferramenta paga exige justificativa de ROI + aprova��o expl�cita do Operador.
- PENDENCIAS_OPERADOR.md n�o ganha itens de ferramentas pagas.
